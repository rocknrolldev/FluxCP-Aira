            ...
            <form action="<?php echo $this->urlWithQs ?>" method="post">
                <div class="block block-themed block-rounded block-shadow ">
                    ...
                    <ul class="nav nav-tabs nav-tabs-alt row no-gutters">
                            ...
                            <a class="nav-link active "><i class="bi bi-person-fill"></i> Sign In Form</a>
				...
				<?php endif ?>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input type="text" class="form-control" id="userid" name="userid" placeholder="your username">
                                                                                    <div class="form-text text-muted"><?php echo htmlspecialchars(Flux::message('ResendAccountInfo')) ?></div>
                                        
                                    </div>
                                <div class="col-12">
                                    <label for="t-signup-password"><?php echo htmlspecialchars(Flux::message('ResendEmailLabel')) ?></label>
            ...
            <div class="form-group row mb-0">
                                ...
                                <div class="col-sm-12 text-sm-right push">
                                    ...
                                    <button type="submit" class="btn btn-alt-success">
                                       <?php echo htmlspecialchars(Flux::message('ResendButton')) ?>                                    </button>
                                </div>
                            </div>
                                            </div>
