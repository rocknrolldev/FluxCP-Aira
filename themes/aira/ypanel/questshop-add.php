                ...
                <?php endif ?></p>
                                ...
                                <form action="<?php echo $this->urlWithQs ?>" method="post" enctype="multipart/form-data">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="questshop_title" name="questshop_title" placeholder="Exm : Red Potion">
                                    </div>
                                    
                                    <div class="row g-2">
                                        <div class="mb-3 col-md-6">
                                            <label for="blog_path" class="form-label">Path</label>
                                            <input type="text" class="form-control" id="questshop_path" name="questshop_path" placeholder="red-potion, for a good link please dont use space">
                                        </div>
                                        <div class="mb-3 col-md-6">
                                            <label for="questshop_position" class="form-label">Atribut Position</label>
                                            <input type="text" class="form-control" id="questshop_position" name="questshop_position" placeholder="Costume Garment">
                                        </div>
                                    </div>
