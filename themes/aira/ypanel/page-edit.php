                ...
                <?php endif ?></p>
                                <form action="<?php echo $this->urlWithQs ?>" method="post" enctype="multipart/form-data">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="page_title" name="page_title" placeholder="Exm : Patch Update v1" value="<?php echo htmlspecialchars($title) ?>">
                                    </div>

                                    <div class="mb-3">
                                        <label for="inputAddress" class="form-label">Path</label>
                                        <input type="text" class="form-control" id="page_path" name="page_path" placeholder="Exm : patch-update-v1, will be good without (space)" value="<?php echo htmlspecialchars($path) ?>">
                                    </div>
                                    
                                    <div class="mb-3">
                                        <textarea class="form-control" name="page_body" id="page_body"/><?php echo htmlspecialchars($body) ?></textarea></br>
                                    </div>
