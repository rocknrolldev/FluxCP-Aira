                ...
                <?php endif ?></p>
                                ...
                                <form action="<?php echo $this->urlWithQs ?>" method="post" enctype="multipart/form-data">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="npc_title" name="npc_title" placeholder="Exm : Patch Update v1">
                                    </div>

                                    <div class="row g-2">
                                        <div class="mb-3 col-md-6">
                                            <label for="npc_path" class="form-label">Path</label>
                                            <input type="text" class="form-control" id="npc_path" name="npc_path" placeholder="Exm : update-path-v1, for a good link please dont use space">
                                        </div>
                                        <div class="mb-3 col-md-6">
                                    ...
                                    <div class="mb-3">
                                        <textarea class="form-control" name="npc_body" id="npc_body"/></textarea></br>
                                    </div>
