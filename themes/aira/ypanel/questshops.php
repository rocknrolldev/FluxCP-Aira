                            ...
                            <div class="page-title-box">
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">Questshop List</li>
                                    </ol>
                                </div>
                                <h4 class="page-title">Quest Shop</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                                    ...
                                    <?php if($questshops): ?>
                                       <?php foreach($questshops as $prow):?>
                                        <tr>
                                            ...
                                            <td><?php echo $prow->position?>              </td>            </td>
                                            <td><a href="<?php echo $this->url('ypanel', 'questshop-edit', array('id' => $prow->id)); ?>"><?php echo htmlspecialchars(Flux::message('CMSEdit')) ?></a></td>
                                            <td><a href="<?php echo $this->url('ypanel', 'questshop-delete', array('id' => $prow->id)); ?>" onclick="return confirm('<?php echo htmlspecialchars(Flux::message('CMSConfirmDelete')) ?>');"><?php echo htmlspecialchars(Flux::message('CMSDelete')) ?></a></td>
                                        </tr>
                                        <?php endforeach;?>
