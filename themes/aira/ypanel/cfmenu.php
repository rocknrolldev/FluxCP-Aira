                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="page-title-box">
                                ...
                                <h4 class="page-title">Footer more Menu</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                                    ...
                                    <?php if($cfmenus): ?>
                                       <?php foreach($cfmenus as $prow):?>
                                        <tr>
                                            ...
                                            <td><a href="<?php echo $this->url('ypanel', 'cfmenu-edit', array('id' => $prow->id)); ?>"><?php echo htmlspecialchars(Flux::message('CMSEdit')) ?></a></td>
                                        </tr>
                                        <?php endforeach;?>
                                        <?php endif ?>
                                    </tbody>
