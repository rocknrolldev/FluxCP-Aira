...
return array(
	...
	'modules' => array(
		...
		'ypanel'    => array(
            'index'    => AccountLevel::ADMIN,
            'blog-edit'   => AccountLevel::ADMIN,
            'blog-delete'   => AccountLevel::ADMIN,
            'blog-add' => AccountLevel::ADMIN,
            'blog'  => AccountLevel::ADMIN,
            'cfmenu-edit'  => AccountLevel::ADMIN,
            'cfmenu'   => AccountLevel::ADMIN,
            'download-add' => AccountLevel::ADMIN,
            'download-delete'  => AccountLevel::ADMIN,
            'download-edit'  => AccountLevel::ADMIN,
            'download'   => AccountLevel::ADMIN,
            'feature-add' => AccountLevel::ADMIN,
            'feature-delete'  => AccountLevel::ADMIN,
            'feature-edit'  => AccountLevel::ADMIN,
            'feature'   => AccountLevel::ADMIN,
            'fmenu-edit' => AccountLevel::ADMIN,
            'fmenu'  => AccountLevel::ADMIN,
            'iteminfo'  => AccountLevel::ADMIN,
            'menu-edit'   => AccountLevel::ADMIN,
            'menu' => AccountLevel::ADMIN,
            'npc-add'  => AccountLevel::ADMIN,
            'npc-delete'  => AccountLevel::ADMIN,
            'npc-edit'   => AccountLevel::ADMIN,
            'npc-gallery' => AccountLevel::ADMIN,
            'npc'  => AccountLevel::ADMIN,
            'page-add'  => AccountLevel::ADMIN,
            'page-delete'   => AccountLevel::ADMIN,
            'page-edit' => AccountLevel::ADMIN,
            'pages'  => AccountLevel::ADMIN,
            'questshop-add'  => AccountLevel::ADMIN,
            'questshop-delete'   => AccountLevel::ADMIN,
            'questshop-edit' => AccountLevel::ADMIN,
            'questshop-gallery'  => AccountLevel::ADMIN,
            'questshops'  => AccountLevel::ADMIN,
            'referral-delete'   => AccountLevel::ADMIN,
            'referral-edit' => AccountLevel::ADMIN,
            'referral-gallery'  => AccountLevel::ADMIN,
            'referrals'  => AccountLevel::ADMIN,
            'server'   => AccountLevel::ADMIN,
            'smenu-edit' => AccountLevel::ADMIN,
            'smenu'  => AccountLevel::ADMIN,
            'store-add'  => AccountLevel::ADMIN,
            'store-delete' => AccountLevel::ADMIN,
            'store-edit'  => AccountLevel::ADMIN,
            'store-gallery'  => AccountLevel::ADMIN,
            'store' => AccountLevel::ADMIN,
            'streamer-add'  => AccountLevel::ADMIN,
            'streamer-delete'  => AccountLevel::ADMIN,
            'streamer-edit' => AccountLevel::ADMIN,
            'streamer-gallery'  => AccountLevel::ADMIN,
            'streamers'  => AccountLevel::ADMIN
        ),
	),
